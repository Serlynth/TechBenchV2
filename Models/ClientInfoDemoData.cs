    ...
    public static ClientInfoDemoSnapshotData Create()
    {
        ...
        var resources = new[]
        {
            ...
            Resource(-102, ClientInfoResourceCategories.ConnectionInternet, "Main WatchGuard", "WatchGuard Firewall", "WatchGuard", "https://10.20.0.1", "Main Office", -1,
                new Dictionary<string, string> { ["public_wan_ip"]="203.0.113.26", ["ssl_vpn_port"]="443", ["gateway"]="203.0.113.25", ["subnet_cidr"]="203.0.113.24/29", ["circuit_id"]="DEMO-COMCAST-4821", ["device_model"]="Firebox M390", ["serial_number"]="WG-DEMO-390", ["firmware_version"]="Fireware 12.10.4", ["isp_provider"]="Comcast Business", ["support_phone"]="800-555-0188", ["account_number"]="", ["service_type"]="", ["bandwidth"]="", ["support_contact"]="" }),
            Resource(-115, ClientInfoResourceCategories.ConnectionInternet, "Comcast Business Internet", "Internet Circuit", "Comcast Business", "https://business.comcast.com/account", "Main Office", -1,
                new Dictionary<string, string> { ["public_wan_ip"]="203.0.113.26", ["ssl_vpn_port"]="", ["gateway"]="203.0.113.25", ["subnet_cidr"]="203.0.113.24/29", ["ip_assignment_type"]="Static block", ["usable_static_ip_count"]="5", ["static_ip_addresses"]="", ["static_ip_range_start"]="203.0.113.26", ["static_ip_range_end"]="203.0.113.30", ["circuit_id"]="DEMO-COMCAST-4821", ["device_model"]="Comcast Business Gateway", ["serial_number"]="DEMO-CBR-1001", ["firmware_version"]="", ["isp_provider"]="Comcast Business", ["support_phone"]="800-555-0188", ["account_number"]="DEMO-ACCOUNT-1048", ["service_type"]="Comcast Business Internet", ["bandwidth"]="1.25 Gbps down / 35 Mbps up", ["support_contact"]="Comcast Business Support" }),
