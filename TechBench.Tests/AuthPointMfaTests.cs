...
public sealed class AuthPointMfaTests
{
    ...
    [Fact]
    public void FireDrillStaysOutsideAuthPointPathAndStableClientRequiresLoginApproval()
    {
        ...
        Assert.DoesNotContain("#if TECHBENCH_CLIENT_INFO_BETA", connectionWindow, StringComparison.Ordinal);
