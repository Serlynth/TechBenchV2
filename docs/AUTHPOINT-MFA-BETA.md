...
> Historical rollout notes: AuthPoint support graduated into Stable TechBench
> 0.7.0. Use the current Stable client, TechBench Server package, and SQL package
> for new deployments; the old Beta feed is now migration-only.
