...
The current workbook format is `TB-CI-5`. It intentionally hides technical row
keys, uses ordinary worksheet labels, and separates technology information by
category, including a dedicated Wi-Fi tab. Workbooks generated by the earlier
`TB-CI-4`, `TB-CI-3`, `TB-CI-2`, and `TB-CI-1` betas remain importable.
